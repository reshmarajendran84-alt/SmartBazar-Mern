...
//   <Link
//     to={`/orders/${order._id}`}
//     className="text-sm text-white bg-indigo-600 px-4 py-1.5 rounded-lg hover:bg-indigo-700"
//   >
//     View Details
//   </Link>
//   <button
    ...
    <div className="bg-white border rounded-2xl shadow-sm mb-4 overflow-hidden">
      ...
      <div className="px-4 py-3 flex justify-between items-center flex-wrap sm:flex-nowrap gap-2">
        ...
        <div className="flex items-center gap-3">
          {/* 
            Link goes to /orders/:id — opens OrderDetailPage
            The orderId in the URL is the full MongoDB _id
          */}
