...
const handleLogin = async () => {
  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 space-y-6 transition-all duration-300">
        ...
        <p
          ...
          className="text-sm text-indigo-600 text-center hover:underline cursor-pointer"
        >
          Forgot Password?
        </p>
